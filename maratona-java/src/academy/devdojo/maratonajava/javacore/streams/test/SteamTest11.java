...
public class SteamTest11 {
    ...
    public static void main(String[] args) {
        ...
        lightNovels.stream().mapToDouble(LightNovel::getPrice)
                .average()
                .ifPresent(System.out::println);

        Double collect1 = lightNovels.stream().collect(Collectors.averagingDouble(LightNovel::getPrice));
        System.out.println(collect1);

        DoubleSummaryStatistics collect2 = lightNovels.stream().collect(Collectors.summarizingDouble(LightNovel::getPrice));
        System.out.println(collect2);

        String collect3 = lightNovels.stream()
